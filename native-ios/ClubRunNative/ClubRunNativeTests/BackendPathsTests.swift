...
final class BackendPathsTests: XCTestCase {
    func testCentralizesFirebasePaths() {
        ...
        XCTAssertEqual(BackendPaths.driverStats("run_1", uid: "uid_1"), "runs/run_1/drivers/uid_1/stats")
        XCTAssertEqual(BackendPaths.driverSummary("run_1", uid: "uid_1"), "runs/run_1/drivers/uid_1/summary")
